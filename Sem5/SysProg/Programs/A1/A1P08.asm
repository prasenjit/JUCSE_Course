; Make sure to add a space at last of input, e.g. "22 33 44 "
...
max2msg db CR, LF,'max is: $'
min2msg db CR, LF, 'min is: $'
max1 dw ?
max2 dw ? 
min1 dw ? 
min2 dw ? 
...
; now print max1 and min1

        l3:  mov dx, offset max2msg
        mov ah,9
        int 21h

        mov ax,max1	; print max1
        call putn
